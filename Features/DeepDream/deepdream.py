...
OUTPUTPICTURE = sys.argv[2];
model_fn = '/home/kbhit/git/deepdream/tensorflow_inception_graph.pb'
...
#    scipy.misc.imsave('final_img_naive.jpg', visstd(img))
...
#        clear_output()
#        showarray(visstd(img))
#        scipy.misc.imsave('final_img_multiscale.jpg', visstd(img))
...
#        scipy.misc.imsave('final_img_lapnorm.jpg', visstd(img))
...
#        clear_output()
#        showarray(img/255.0)
        scipy.misc.imsave(OUTPUTPICTURE, img/255.0)
...
img0 = PIL.Image.open(INPUTPICTURE)
